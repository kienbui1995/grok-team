...
export const ptBRSoftwareTeamDlc = {
  ...
  "softwareTeamDlc.deliveryProgressRoles": "{visited}/{total} papéis na cadeia de entrega",
  "softwareTeamDlc.deliveryShipReady": "Portão de envio pronto",
  "softwareTeamDlc.deliveryShipBlocked": "Portão de envio bloqueado",
