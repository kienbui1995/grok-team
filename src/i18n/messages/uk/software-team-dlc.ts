...
export const ukSoftwareTeamDlc = {
  ...
  "softwareTeamDlc.redo": "Повторити",
  "softwareTeamDlc.redone": "Зміну дошки повторено.",
  "softwareTeamDlc.redoEmpty": "Немає що повторювати.",
  "softwareTeamDlc.duplicateDelivery": "Дублювати поставку",
  "softwareTeamDlc.duplicateSuffix": " (копія)",
  "softwareTeamDlc.duplicated": "Поставку скопійовано. Нові картки не прив’язані.",
  "softwareTeamDlc.duplicateFailed": "Не вдалося дублювати цю поставку.",
  "softwareTeamDlc.deliveryName": "Назва поставки",
  "softwareTeamDlc.deliveryRename": "Зберегти назву",
  "softwareTeamDlc.deliveryRenamed": "Назву поставки збережено.",
  "softwareTeamDlc.deliveryRenameNeedTitle": "Задайте назву перед збереженням.",
  "softwareTeamDlc.activity.delivery_renamed": "Поставку перейменовано",
  "softwareTeamDlc.activity.delivery_duplicated": "Поставку продубльовано",
  "softwareTeamDlc.bindThisChat": "Прив’язати цей чат",
  "softwareTeamDlc.bindThisChatDone": "Цей чат прив’язано до картки.",
  "softwareTeamDlc.bindThisChatNeedSession": "Спочатку відкрийте чат, потім прив’яжіть його.",
  "softwareTeamDlc.bindThisChatAlready": "Цей чат уже на цій картці.",
  "softwareTeamDlc.unbindSessionDone": "Сесію відв’язано. Чат лишається.",
  "softwareTeamDlc.moveToDelivery": "Перенести до поставки",
  "softwareTeamDlc.movedToDelivery": "Картку перенесено до {title}.",
  "softwareTeamDlc.movedUngrouped": "Картка без групи.",
  "softwareTeamDlc.activity.item_moved": "Перенесено до іншої поставки",
