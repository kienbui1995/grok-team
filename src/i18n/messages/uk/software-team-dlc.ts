...
export const ukSoftwareTeamDlc = {
  ...
  "softwareTeamDlc.deliveryProgressRoles": "{visited}/{total} ролей у ланцюжку поставки",
  "softwareTeamDlc.deliveryShipReady": "Шлюз постачання готовий",
  "softwareTeamDlc.deliveryShipBlocked": "Шлюз постачання заблокований",
  ...
  "softwareTeamDlc.priorityP3": "P3 · Звичайний",
  "softwareTeamDlc.priorityClear": "Прибрати пріоритет",
  "softwareTeamDlc.sortLabel": "Сортування",
  "softwareTeamDlc.sortNewest": "Спочатку новіші",
  "softwareTeamDlc.sortOldest": "Спочатку старіші",
  "softwareTeamDlc.sortPriority": "За пріоритетом",
