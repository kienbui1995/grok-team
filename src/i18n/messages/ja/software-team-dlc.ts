...
export const jaSoftwareTeamDlc = {
  ...
  "softwareTeamDlc.deliveryProgressRoles": "デリバリーの連鎖で {visited}/{total} 役割を通過",
  "softwareTeamDlc.deliveryShipReady": "Ship ゲート準備完了",
  "softwareTeamDlc.deliveryShipBlocked": "Ship ゲートはブロック中",
  ...
  "softwareTeamDlc.priorityP3": "P3 · 通常",
  "softwareTeamDlc.priorityClear": "優先度を解除",
  "softwareTeamDlc.sortLabel": "並び替え",
  "softwareTeamDlc.sortNewest": "新しい順",
  "softwareTeamDlc.sortOldest": "古い順",
  "softwareTeamDlc.sortPriority": "優先度順",
