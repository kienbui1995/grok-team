...
export const koSoftwareTeamDlc = {
  ...
  "softwareTeamDlc.deliveryProgressRoles": "전달 체인에서 {visited}/{total}개 역할 통과",
  "softwareTeamDlc.deliveryShipReady": "Ship 게이트 준비됨",
  "softwareTeamDlc.deliveryShipBlocked": "Ship 게이트 차단됨",
  ...
  "softwareTeamDlc.priorityP3": "P3 · 보통",
  "softwareTeamDlc.priorityClear": "우선순위 지우기",
  "softwareTeamDlc.sortLabel": "정렬",
  "softwareTeamDlc.sortNewest": "최신순",
  "softwareTeamDlc.sortOldest": "오래된 순",
  "softwareTeamDlc.sortPriority": "우선순위순",
