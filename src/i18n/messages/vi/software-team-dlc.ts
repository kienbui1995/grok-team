...
export const viSoftwareTeamDlc = {
  ...
  "softwareTeamDlc.deliveryProgressRoles": "{visited}/{total} vai trong chuỗi đợt giao",
  "softwareTeamDlc.deliveryShipReady": "Cổng ship đã sẵn sàng",
  "softwareTeamDlc.deliveryShipBlocked": "Cổng ship đang bị chặn",
  ...
  "softwareTeamDlc.priorityP3": "P3 · Thường",
  "softwareTeamDlc.priorityClear": "Xoá mức ưu tiên",
  "softwareTeamDlc.sortLabel": "Sắp xếp",
  "softwareTeamDlc.sortNewest": "Mới nhất trước",
  "softwareTeamDlc.sortOldest": "Cũ nhất trước",
  "softwareTeamDlc.sortPriority": "Theo mức ưu tiên",
