...
export const itSoftwareTeamDlc = {
  ...
  "softwareTeamDlc.deliveryProgressRoles": "{visited}/{total} ruoli nella catena di consegna",
  "softwareTeamDlc.deliveryShipReady": "Cancello di spedizione pronto",
  "softwareTeamDlc.deliveryShipBlocked": "Cancello di spedizione bloccato",
  ...
  "softwareTeamDlc.activity.priority": "Priorità modificata",
  "softwareTeamDlc.activity.laya_suggest": "Suggerimento Laya",
  "softwareTeamDlc.priorityMenu": "Priorità",
  "softwareTeamDlc.priorityP1": "P1 · Urgente",
  "softwareTeamDlc.priorityP2": "P2 · Alta",
  "softwareTeamDlc.priorityP3": "P3 · Normale",
  "softwareTeamDlc.priorityClear": "Rimuovi priorità",
  "softwareTeamDlc.sortLabel": "Ordina",
  "softwareTeamDlc.sortNewest": "Più recenti prima",
  "softwareTeamDlc.sortOldest": "Più vecchi prima",
  "softwareTeamDlc.sortPriority": "Per priorità",
  ...
  "softwareTeamDlc.layaHostTimeout":
    "Timeout di Laya. La prima chiamata può richiedere fino a 60 secondi mentre i pesi si caricano; le chiamate successive si fermano dopo 15 secondi. Nessun suggerimento restituito.",
