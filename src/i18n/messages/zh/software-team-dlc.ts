...
export const zhSoftwareTeamDlc = {
  ...
  "softwareTeamDlc.markProductNote": "填写产品备注",
  "softwareTeamDlc.markArchitectNote": "填写架构备注",
  "softwareTeamDlc.productNote": "产品备注",
  "softwareTeamDlc.productNotePlaceholder": "范围、用户、成功标准。",
  "softwareTeamDlc.architectNote": "架构备注",
  "softwareTeamDlc.architectNotePlaceholder": "设计决策、取舍、边界。",
  ...
  "softwareTeamDlc.startDeliveryTemplate": "模板",
  "softwareTeamDlc.templateFeature": "新功能",
  "softwareTeamDlc.templateBugfix": "修复缺陷",
  "softwareTeamDlc.templateHotfix": "紧急修复",
  "softwareTeamDlc.templateDocs": "仅文档",
  "softwareTeamDlc.startDeliveryBootstrap": "添加 docs/sdlc 占位文件",
  "softwareTeamDlc.startDeliveryBootstrapHint":
    "按模板把缺失的占位文件写入本项目 docs/sdlc。需要桌面 Host 和项目文件夹。",
  ...
  "softwareTeamDlc.deliveryProgressRoles": "交付链已过 {visited}/{total} 个角色",
  "softwareTeamDlc.deliveryShipReady": "Ship 门禁已就绪",
  "softwareTeamDlc.deliveryShipBlocked": "Ship 门禁未通过",
  ...
  "softwareTeamDlc.priorityP3": "P3 · 普通",
  "softwareTeamDlc.priorityClear": "清除优先级",
  "softwareTeamDlc.sortLabel": "排序",
  "softwareTeamDlc.sortNewest": "最新优先",
  "softwareTeamDlc.sortOldest": "最旧优先",
  "softwareTeamDlc.sortPriority": "按优先级",
  ...
  "softwareTeamDlc.handoffKept": "已打开 {role}。此卡片仍是 {from}。",
  "softwareTeamDlc.handoffCreated": "已添加 {role} 卡片。此卡片仍是 {from}。",
  "softwareTeamDlc.shipKept": "已打开 Writer。此卡片仍是 {from}。",
  "softwareTeamDlc.conflictTitle": "项目流水线文件冲突",
  "softwareTeamDlc.conflictBody":
    "项目流水线文件已在别处更改，而本窗口看板仍有未保存改动。请选择保留哪一份。另一份可留在 {file}。",
  "softwareTeamDlc.conflictUseFile": "使用项目文件",
  "softwareTeamDlc.conflictKeepBoard": "保留本看板",
  "softwareTeamDlc.conflictUsedFile": "已用项目文件替换看板。",
  ...
  "softwareTeamDlc.layaHostTimeout":
    "Laya 超时。首次调用在加载权重时最多可等 60 秒；之后的调用在 15 秒后停止。没有返回建议。",
