...
export const deSoftwareTeamDlc = {
  ...
  "softwareTeamDlc.deliveryProgressRoles": "{visited}/{total} Rollen in der Lieferkette",
  "softwareTeamDlc.deliveryShipReady": "Ship-Gate bereit",
  "softwareTeamDlc.deliveryShipBlocked": "Ship-Gate blockiert",
  ...
  "softwareTeamDlc.layaHostTimeout":
    "Zeitüberschreitung bei Laya. Der erste Aufruf kann bis zu 60 Sekunden dauern, während die Gewichte laden; spätere Aufrufe enden nach 15 Sekunden. Es wurde kein Vorschlag zurückgegeben.",
