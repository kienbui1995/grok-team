...
export const filSoftwareTeamDlc = {
  ...
  "softwareTeamDlc.bindThisChat": "I-bind ang chat na ito",
  "softwareTeamDlc.bindThisChatDone": "Naka-bind na ang chat na ito sa card.",
  "softwareTeamDlc.bindThisChatNeedSession": "Magbukas muna ng chat, saka i-bind.",
  "softwareTeamDlc.bindThisChatAlready": "Naka-bind na ang chat na ito sa card na ito.",
  "softwareTeamDlc.unbindSessionDone": "Inalis ang bind. Nanatili ang chat.",
  "softwareTeamDlc.moveToDelivery": "Ilipat sa delivery",
  "softwareTeamDlc.movedToDelivery": "Inilipat ang card sa {title}.",
  "softwareTeamDlc.movedUngrouped": "Walang grupo ang card.",
  "softwareTeamDlc.activity.item_moved": "Inilipat sa ibang delivery",
  ...
  "softwareTeamDlc.priorityP3": "P3 · Karaniwan",
  "softwareTeamDlc.priorityClear": "Alisin ang priyoridad",
  "softwareTeamDlc.sortLabel": "Ayusin",
  "softwareTeamDlc.sortNewest": "Pinakabago muna",
  "softwareTeamDlc.sortOldest": "Pinakaluma muna",
  "softwareTeamDlc.sortPriority": "Ayon sa priyoridad",
