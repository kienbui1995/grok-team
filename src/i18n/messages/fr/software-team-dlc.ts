...
export const frSoftwareTeamDlc = {
  ...
  "softwareTeamDlc.deliveryProgressRoles": "{visited}/{total} rôles dans la chaîne de livraison",
  "softwareTeamDlc.deliveryShipReady": "Barrière de livraison prête",
  "softwareTeamDlc.deliveryShipBlocked": "Barrière de livraison bloquée",
  ...
  "softwareTeamDlc.activity.laya_suggest": "Suggestion Laya",
  ...
  "softwareTeamDlc.layaHostTimeout":
    "Délai Laya dépassé. Le premier appel peut prendre jusqu’à 60 secondes le temps de charger les poids ; les appels suivants s’arrêtent après 15 secondes. Aucune suggestion n’a été renvoyée.",
