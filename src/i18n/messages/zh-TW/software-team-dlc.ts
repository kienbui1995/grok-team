...
export const zhTWSoftwareTeamDlc = {
  ...
  "softwareTeamDlc.deliveryProgressRoles": "交付鏈已過 {visited}/{total} 個角色",
  "softwareTeamDlc.deliveryShipReady": "Ship 閘門已就緒",
  "softwareTeamDlc.deliveryShipBlocked": "Ship 閘門未通過",
  ...
  "softwareTeamDlc.bindThisChat": "綁定目前對話",
  "softwareTeamDlc.bindThisChatDone": "已把目前對話綁到這張卡片。",
  "softwareTeamDlc.bindThisChatNeedSession": "先開啟一個對話，再綁定。",
  "softwareTeamDlc.bindThisChatAlready": "目前對話已經在這張卡片上。",
  "softwareTeamDlc.unbindSessionDone": "已解除綁定。對話仍在。",
  "softwareTeamDlc.moveToDelivery": "移到其他交付",
  "softwareTeamDlc.movedToDelivery": "已把卡片移到 {title}。",
  "softwareTeamDlc.movedUngrouped": "卡片已取消分組。",
  ...
  "softwareTeamDlc.priorityClear": "清除優先順序",
  "softwareTeamDlc.sortLabel": "排序",
  "softwareTeamDlc.sortNewest": "最新優先",
  "softwareTeamDlc.sortOldest": "最舊優先",
  "softwareTeamDlc.sortPriority": "依優先順序",
