...
export const ruSoftwareTeamDlc = {
  ...
  "softwareTeamDlc.deliveryProgressRoles": "{visited}/{total} ролей в цепочке поставки",
  "softwareTeamDlc.deliveryShipReady": "Шлюз поставки готов",
  "softwareTeamDlc.deliveryShipBlocked": "Шлюз поставки заблокирован",
  ...
  "softwareTeamDlc.priorityP3": "P3 · Обычный",
  "softwareTeamDlc.priorityClear": "Убрать приоритет",
  "softwareTeamDlc.sortLabel": "Сортировка",
  "softwareTeamDlc.sortNewest": "Сначала новые",
  "softwareTeamDlc.sortOldest": "Сначала старые",
  "softwareTeamDlc.sortPriority": "По приоритету",
