...
export const idSoftwareTeamDlc = {
  ...
  "softwareTeamDlc.deliveryProgressRoles": "{visited}/{total} peran dalam rantai delivery",
  "softwareTeamDlc.deliveryShipReady": "Gerbang ship siap",
  "softwareTeamDlc.deliveryShipBlocked": "Gerbang ship terblokir",
