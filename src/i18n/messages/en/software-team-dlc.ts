...
export const enSoftwareTeamDlc = {
  ...
  "softwareTeamDlc.deliveryProgressRoles": "{visited}/{total} roles on the delivery chain",
  "softwareTeamDlc.deliveryShipReady": "Ship gate ready",
  "softwareTeamDlc.deliveryShipBlocked": "Ship gate blocked",
  ...
  "softwareTeamDlc.activity.priority": "Changed priority",
  "softwareTeamDlc.activity.laya_suggest": "Laya suggestion",
  "softwareTeamDlc.priorityMenu": "Priority",
  "softwareTeamDlc.priorityP1": "P1 · Urgent",
  "softwareTeamDlc.priorityP2": "P2 · High",
  "softwareTeamDlc.priorityP3": "P3 · Normal",
  "softwareTeamDlc.priorityClear": "Clear priority",
  "softwareTeamDlc.sortLabel": "Sort",
  "softwareTeamDlc.sortNewest": "Newest first",
  "softwareTeamDlc.sortOldest": "Oldest first",
  "softwareTeamDlc.sortPriority": "By priority",
  ...
  "softwareTeamDlc.layaHostTimeout":
    "Laya timed out. The first call can take up to 60 seconds while weights load; later calls stop after 15 seconds. No suggestion was returned.",
