...
export const EXTENSIONS_ENTRIES: readonly SettingsEntry[] = [
  ...
  },
  {
    ...
    descKeys: [
      ...
      "softwareTeamDlc.showArchived",
      "softwareTeamDlc.conflictTitle",
      "softwareTeamDlc.conflictBody",
      "softwareTeamDlc.conflictUseFile",
      "softwareTeamDlc.conflictKeepBoard",
      "softwareTeamDlc.layaEnable",
      "softwareTeamDlc.layaEnableDesc",
      "softwareTeamDlc.layaMinConfidence",
    ],
    keywords: [
      "software works",
      "sdlc studio",
